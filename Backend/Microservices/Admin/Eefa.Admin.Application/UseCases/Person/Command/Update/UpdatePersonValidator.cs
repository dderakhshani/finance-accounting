...
namespace Eefa.Admin.Application.CommandQueries.Person.Command.Update
{
    public class UpdatePersonValidator : AbstractValidator<UpdatePersonCommand>
    {
        ...
        public UpdatePersonValidator(IRepository repository)
        {
            RuleFor(x => x.Id)
        ...
        public async Task<bool> IsLegalPerson(UpdatePersonCommand request, CancellationToken cancellationToken)
        {
