...
public class UpdatePersonAddressValidator : AbstractValidator<UpdatePersonAddressCommand>
{
    ...
    //private async Task<bool> ValidateMobiles(IList<PhoneNumber> list, CancellationToken token)
    //{
