...
{
    public class ReceiptCommodityModel : IMapFrom<Domain.Commodity>
    {
        ...
        {
            profile.CreateMap<Domain.Commodity, ReceiptCommodityModel>();
            profile.CreateMap<ViewCommodity, ReceiptCommodityModel>();
