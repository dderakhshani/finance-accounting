...
namespace Eefa.WorkflowAdmin.WebApi.Domain.Databases.Entities
{
    ...
    public partial class User : BaseEntity
    {
        ...
        public virtual ICollection<CorrectionRequest> CorrectionRequestsCreatedBies { get; set; } = default!;
        public virtual ICollection<CorrectionRequest> CorrectionRequestsModifiedBies { get; set; } = default!;
        public virtual ICollection<CorrectionRequest> CorrectionRequestsVerifierUsers { get; set; } = default!;
