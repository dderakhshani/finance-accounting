...
using AutoMapper;
using Eefa.Accounting.Application.UseCases.AccountHeadRelReferenceGroup.Model;
using Library.Interfaces;
using Library.Mappings;

namespace Eefa.Accounting.Application.UseCases.AccountHead.Model
{
    public class AccountHeadModel : IMapFrom<Data.Entities.AccountHead>, IHierarchicalBaseEntity
    {
        ...
        public ICollection<Data.Entities.AccountHead> AccountHeads { get; set; }
        public ICollection<AccountHeadRelReferenceGroupModel>? AccountHeadRelReferenceGroups { get; set; }

        public void Mapping(Profile profile)
        {
            profile.CreateMap<Data.Entities.AccountHead, AccountHeadModel>()
