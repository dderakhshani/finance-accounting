...
namespace Eefa.Accounting.Application.UseCases.Moadian.MoadianInvoiceDetail.Model
{
    public class MoadianInvoiceDetailModel : IMapFrom<Data.Entities.MoadianInvoiceDetail>
    {
        ...
        {
            profile.CreateMap<Data.Entities.MoadianInvoiceDetail, MoadianInvoiceDetailModel>();
        }
    }
}
