...
{
    public class CreateMoadianInvoiceDetailCommand : CommandBase, IRequest<ServiceResult>, IMapFrom<CreateMoadianInvoiceDetailCommand>, ICommand
    {
        ...
        {
            profile.CreateMap<CreateMoadianInvoiceDetailCommand, Data.Entities.MoadianInvoiceDetail>()
                .IgnoreAllNonExisting();
        }
    }


    public class CreateMoadianInvoiceDetailCommandHandler : IRequestHandler<CreateMoadianInvoiceDetailCommand, ServiceResult>
    {
        private readonly IRepository _repository;
        private readonly IMapper _mapper;
        public CreateMoadianInvoiceDetailCommandHandler()
        {

        }
        public async Task<ServiceResult> Handle(CreateMoadianInvoiceDetailCommand request, CancellationToken cancellationToken)
        {
