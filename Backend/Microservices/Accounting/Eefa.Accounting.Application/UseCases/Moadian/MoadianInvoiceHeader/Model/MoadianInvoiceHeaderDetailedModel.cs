using AutoMapper;
using Eefa.Accounting.Application.UseCases.Moadian.MoadianInvoiceDetail.Model;
...
{
    public class MoadianInvoiceHeaderDetailedModel : IMapFrom<Data.Entities.MoadianInvoiceHeader>
    {
        ...
        {
            profile.CreateMap<Data.Entities.MoadianInvoiceHeader, MoadianInvoiceHeaderDetailedModel>()
