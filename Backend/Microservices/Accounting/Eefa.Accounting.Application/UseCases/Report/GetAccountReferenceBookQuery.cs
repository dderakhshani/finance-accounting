...
{
    public class GetAccountReferenceBookQuery : Pagination, IMapFrom<GetAccountReferenceBookQuery>, IRequest<ServiceResult>, ISearchableRequest, IQuery
    {
    ...
    public class GetAccountReferenceBookQueryHandler : IRequestHandler<GetAccountReferenceBookQuery, ServiceResult>
    {
        ...
        public GetAccountReferenceBookQueryHandler(IAccountingUnitOfWorkProcedures accountingUnitOfWorkProcedures, ICurrentUserAccessor currentUserAccessor, IMapper mapper)
        {
