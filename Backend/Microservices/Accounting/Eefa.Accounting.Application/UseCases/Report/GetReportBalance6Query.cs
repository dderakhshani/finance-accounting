...
{
    public class GetReportBalance6Query : Pagination, IMapFrom<GetReportBalance6Query>, IRequest<ServiceResult>, ISearchableRequest, IQuery
    {
    ...
    public class GetReportBalance6QueryHandler : IRequestHandler<GetReportBalance6Query, ServiceResult>
    {
        ...
        public GetReportBalance6QueryHandler(IAccountingUnitOfWorkProcedures accountingUnitOfWorkProcedures, ICurrentUserAccessor currentUserAccessor, IMapper mapper, IRepository repository)
        {
