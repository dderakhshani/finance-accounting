...
{
    public class StpReportReference2AccountHeadQuery : Pagination, IMapFrom<StpReportReference2AccountHeadQuery>, IRequest<ServiceResult>, ISearchableRequest, IQuery
    {
    ...
    public class StpReportReference2AccountHeadQueryHandler : IRequestHandler<StpReportReference2AccountHeadQuery, ServiceResult>
    {
        ...
        public StpReportReference2AccountHeadQueryHandler(IAccountingUnitOfWorkProcedures accountingUnitOfWorkProcedures, ICurrentUserAccessor currentUserAccessor, IMapper mapper)
        {
