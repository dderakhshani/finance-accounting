...
namespace Eefa.Accounting.Data.Databases.SqlServer.Context
{
    ...
    public class DanaAccountingUnitOfWork : AuditableDbContext, IAccountingUnitOfWork
    {
        ...
        private readonly DanaAccountingUnitOfWork _appDbContext;

        public DanaAccountingUnitOfWork(DbContextOptions<DanaAccountingUnitOfWork> options)
            : base(options)
        {
            _appDbContext = this;
        }
