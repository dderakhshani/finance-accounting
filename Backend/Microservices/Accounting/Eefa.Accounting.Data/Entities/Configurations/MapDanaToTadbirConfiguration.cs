...
{
    public class MapDanaToTadbirConfiguration : IEntityTypeConfiguration<MapDanaToTadbir>
    {
        public void Configure(EntityTypeBuilder<MapDanaToTadbir> builder)
        {
            builder.ToTable("MapDanaToTadbir", "common");
