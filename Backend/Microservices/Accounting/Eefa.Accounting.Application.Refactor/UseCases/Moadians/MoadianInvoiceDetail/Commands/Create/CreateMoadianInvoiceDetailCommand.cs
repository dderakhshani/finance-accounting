...
public class CreateMoadianInvoiceDetailCommand : IRequest<ServiceResult<MoadianInvoiceDetailModel>>, IMapFrom<CreateMoadianInvoiceDetailCommand>
{
    ...
    {
        profile.CreateMap<CreateMoadianInvoiceDetailCommand, MoadianInvoiceDetail>()
            .IgnoreAllNonExisting();
    }
}

public class CreateMoadianInvoiceDetailCommandHandler : IRequestHandler<CreateMoadianInvoiceDetailCommand, ServiceResult<MoadianInvoiceDetailModel>>
{
    private readonly IMapper _mapper;
    public CreateMoadianInvoiceDetailCommandHandler(IMapper mapper)
    {
        _mapper = mapper;
    }
    public async Task<ServiceResult<MoadianInvoiceDetailModel>> Handle(CreateMoadianInvoiceDetailCommand request, CancellationToken cancellationToken)
    {
