...
//public class GetAccountReviewQuery : IMapFrom<GetAccountReviewQuery>, IRequest<ServiceResult>
//{
...
//    public GetAccountReviewQueryHandler(IAccountingUnitOfWorkProcedures accountingUnitOfWorkProcedures, IApplicationUser applicationUserAccessor, IMapper mapper, IAccountingUnitOfWork context)
//    {
...
//        input.VoucherDateFrom = input.VoucherDateFrom?.AddMilliseconds(1);
...
//            );
//        results = results.ApplyPermission<StpReportBalance6Result, VouchersDetail>//<List<StpReportBalance6Result>, VouchersDetail>()
