...
{
    public partial class BanksConfiguration : IEntityTypeConfiguration<Banks>
    {
        public void Configure(EntityTypeBuilder<Banks> entity)
        {
            entity.ToTable("Banks", "bursary");
            ...
            entity.HasOne(d => d.CreatedBy)
                .WithMany(p => p.BanksCreatedBies)
                .HasForeignKey(d => d.CreatedById)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Banks_Users");

            entity.HasOne(d => d.ModifiedBy)
                .WithMany(p => p.BanksModifiedBies)
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<Banks> entity);
    }
}
