...
{
    public partial class UnitPositionsConfiguration : IEntityTypeConfiguration<UnitPositions>
    {
        public void Configure(EntityTypeBuilder<UnitPositions> entity)
        {
            ...
            entity.HasOne(d => d.CreatedBy)
                .WithMany(p => p.UnitPositionsCreatedBies)
                .HasForeignKey(d => d.CreatedById)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UnitPositions_Users1");

            entity.HasOne(d => d.ModifiedBy)
                .WithMany(p => p.UnitPositionsModifiedBies)
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<UnitPositions> entity);
    }
}
