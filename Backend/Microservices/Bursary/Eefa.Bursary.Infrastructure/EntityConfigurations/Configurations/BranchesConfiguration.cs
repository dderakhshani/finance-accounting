...
{
    public partial class BranchesConfiguration : IEntityTypeConfiguration<Branches>
    {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<Branches> entity);
    }
}
