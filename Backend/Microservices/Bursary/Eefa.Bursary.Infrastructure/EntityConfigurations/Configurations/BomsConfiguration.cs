...
{
    public partial class BomsConfiguration : IEntityTypeConfiguration<Boms>
    {
        public void Configure(EntityTypeBuilder<Boms> entity)
        {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<Boms> entity);
    }
}
