...
namespace Eefa.Logistic.Domain
{
    ...
    public partial class ReceiptView 
    {
        ...
        public string RequesterReferenceTitle { get; set; }
        public Nullable<int> RequesterReferenceId { get; set; }
        public Nullable<int> FollowUpReferenceId { get; set; }
        public string FollowUpReferenceTitle { get; set; }
        public string CorroborantReferenceTitle { get; set; }
        public Nullable<int> CorroborantReferenceId { get; set; }
