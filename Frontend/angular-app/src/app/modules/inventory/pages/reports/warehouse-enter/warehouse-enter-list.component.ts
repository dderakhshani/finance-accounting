...
import {
  GetWarhouseLayoutHistotyByDocumentQuery
} from '../../../repositories/warehouse-layout/queries/warhouse-layouts-report/get-warehouse-layouts-document-history-query';
...
export abstract class WarehouseEnterList extends BaseSetting {
...
//sumAll
  ...
  async print() {
    ...
    if (this.data.length > 0) {
      ...
      this.Service.onPrint(printContents, 'گزارش ورودی کالا انبارها')
    }
  }
