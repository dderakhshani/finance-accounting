...
@Component({
  selector: 'app-leaving-receipt-items-product',
  templateUrl: './leaving-receipt-items-product.component.html',
  styleUrls: ['./leaving-receipt-items-product.component.scss']
})
export class LeavingItemsProductComponent extends BaseComponent {
  child: any;
