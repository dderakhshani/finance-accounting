...
@Component({
  selector: 'app-add-request-commodity-materail',
  templateUrl: './add-request-commodity-materail.component.html',
  styleUrls: ['./add-request-commodity-materail.component.scss']
})
export class AddRequestCommodityMaterialComponent extends BaseComponent {
  ...
  public temp_codeVoucherGroupId: any = 2410;
  ...
  async setValue() {
    ...
    this.form.controls.codeVoucherGroupId.setValue(2410);
    this.form.controls.warehouseId.setValue(30);
