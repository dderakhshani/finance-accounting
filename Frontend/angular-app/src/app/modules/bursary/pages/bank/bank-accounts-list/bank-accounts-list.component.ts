...
import { GetBanksQuery } from '../../../repositories/bank/queries/get-banks-query';
import { GetBankBranchesQuery } from '../../../repositories/bank-branch/queries/get-bank-branches-query';
import { GetBankAccountTypesQuery } from '../../../repositories/bank-account/queries/get-bank-account-types-query';
...
export class BankAccountsListComponent extends BaseTable {
    ...
    async resolve() {
        ...
        forkJoin([
            ...
            this.updateColumnFilteredOptions('bankTitle', banks as any);
