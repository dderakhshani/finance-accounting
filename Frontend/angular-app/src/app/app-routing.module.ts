...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'bursary',
        loadChildren: () =>environment.companyName === 'eefa' ? import('./modules/bursary/bursary.module').then((m => m.BursaryModule)) : import('./modules/chocolate-factory-bursary/bursary.module').then((m => m.BursaryModule))
      },
      {
        path: 'commodity',
